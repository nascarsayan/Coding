...
function BuildGallery
	...
	# build gallery
	build_foreground_cmd="montage \"${target_path}/*[0]\" -background none -geometry $thumbnail_dimensions miff:- | convert - -background none -gravity north -splice 0x140 -bordercolor none -border 100 \"${gallery_thumbnails_pathfile}\""
